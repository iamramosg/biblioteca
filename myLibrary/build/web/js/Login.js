...
function login() {
    ...
    fetch('http://localhost:8081/myLibrary/api/restlibreria/login',
            {
                method: "POST",
            ...
            .then(data => {
                if (data.error) {
                    ...
                    window.location.href = "http://localhost:8081/myLibrary/principal.html";

                } else if(data.rol === 'Administrador'){
                    window.location.href = "http://localhost:8081/myLibrary/administrador.html";
                } else {
                    Swal.fire({
                        position: 'center',
                        icon: 'error',
